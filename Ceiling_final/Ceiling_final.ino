...
// ===========================
#define NOISE_SAFE_THRESHOLD   35.0   // % normalized RMS  -> Safe
#define NOISE_DANGER_THRESHOLD 65.0   // % normalized RMS  -> Danger
#define DENSITY_SAFE           40.0   // %                 -> Safe
#define DENSITY_DANGER         70.0   // %                 -> Danger
#define TEMP_SAFE_MAX          32.0   // °C               -> Safe boundary
#define TEMP_DANGER_MIN        35.0   // °C               -> Danger boundary
#define HUM_SAFE_MAX           70.0   // %RH              -> Safe boundary
#define HUM_DANGER_MIN         80.0   // %RH              -> Danger boundary
...
void readNoise() {
  ...
  // 35% / 65% thresholds from the algorithm can be applied directly.
